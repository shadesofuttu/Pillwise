...
import { Pill, AlertCircle, Globe, RotateCcw, Linkedin, Github, Mail } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#FAF9F7' }}>
      ...
      {/* ── Footer ── */}
      <footer className="w-full border-t border-border py-6 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            {/* Center - Social Icons with Names */}
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="w-8 h-8 rounded-lg border border-border hover:border-accent-muted hover:bg-accent-light transition-all flex items-center justify-center focus:ring-2 focus:ring-accent focus:ring-offset-1"
                    aria-label="Utkarsh's GitHub"
                  >
                  ...
                  >
                    <Linkedin className="w-4 h-4 text-ink-secondary" />
                  </a>
                </div>
                <span className="text-xs font-medium text-ink-muted">Utkarsh</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="w-8 h-8 rounded-lg border border-border hover:border-accent-muted hover:bg-accent-light transition-all flex items-center justify-center focus:ring-2 focus:ring-accent focus:ring-offset-1"
                    aria-label="Deepanshu's LinkedIn"
                  >
                    <Linkedin className="w-4 h-4 text-ink-secondary" />
                  </a>
                </div>
                <span className="text-xs font-medium text-ink-muted">Deepanshu</span>
              </div>
            </div>
